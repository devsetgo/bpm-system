...
from ...models.get_tasks_count_delegation_state import GetTasksCountDelegationState
...
def _get_kwargs(
    *,
    ...
    delegation_state: Union[Unset, None, GetTasksCountDelegationState] = UNSET,
    ...
    url = "{}/task/count".format(client.base_url)
