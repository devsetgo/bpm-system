...
from ...models.get_batches_sort_by import GetBatchesSortBy
from ...models.get_batches_sort_order import GetBatchesSortOrder
...
def _get_kwargs(
    *,
    client: Client,
    sort_by: Union[Unset, None, GetBatchesSortBy] = UNSET,
    sort_order: Union[Unset, None, GetBatchesSortOrder] = UNSET,
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[ExceptionDto, List[BatchDto]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = BatchDto.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[Union[ExceptionDto, List[BatchDto]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    without_tenant_id: Union[Unset, None, bool] = UNSET,
    suspended: Union[Unset, None, bool] = UNSET,
) -> Response[Union[ExceptionDto, List[BatchDto]]]:
    kwargs = _get_kwargs(
        client=client,
        sort_by=sort_by,
...
def sync(
    *,
    ...
    without_tenant_id: Union[Unset, None, bool] = UNSET,
    suspended: Union[Unset, None, bool] = UNSET,
) -> Optional[Union[ExceptionDto, List[BatchDto]]]:
    ...
    [Get Batch Count](https://docs.camunda.org/manual/7.15/reference/rest/batch/get-query-count/) method."""
