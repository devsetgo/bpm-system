...
def _get_kwargs(
    *,
    ...
    url = "{}/batch/statistics/count".format(client.base_url)
...
def sync(
    *,
    ...
    [Get Batch Statistics](https://docs.camunda.org/manual/7.15/reference/rest/batch/get-statistics-query/) method."""
