...
from ...models.extend_lock_on_external_task_dto import ExtendLockOnExternalTaskDto
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: ExtendLockOnExternalTaskDto,
) -> Dict[str, Any]:
    url = "{}/external-task/{id}/extendLock".format(client.base_url, id=id)
