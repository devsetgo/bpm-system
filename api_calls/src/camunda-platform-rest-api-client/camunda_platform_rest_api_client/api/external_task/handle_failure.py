...
from ...models.external_task_failure_dto import ExternalTaskFailureDto
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: ExternalTaskFailureDto,
) -> Dict[str, Any]:
    url = "{}/external-task/{id}/failure".format(client.base_url, id=id)
