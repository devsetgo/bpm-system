...
from ...models.external_task_bpmn_error import ExternalTaskBpmnError
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: ExternalTaskBpmnError,
) -> Dict[str, Any]:
    url = "{}/external-task/{id}/bpmnError".format(client.base_url, id=id)
