...
from ...models.complete_external_task_dto import CompleteExternalTaskDto
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: CompleteExternalTaskDto,
) -> Dict[str, Any]:
    url = "{}/external-task/{id}/complete".format(client.base_url, id=id)
