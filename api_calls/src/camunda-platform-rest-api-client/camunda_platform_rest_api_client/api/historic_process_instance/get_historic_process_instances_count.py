...
from ...models.get_historic_process_instances_count_incident_status import (
    GetHistoricProcessInstancesCountIncidentStatus,
)
...
def _get_kwargs(
    *,
    ...
    incident_status: Union[Unset, None, GetHistoricProcessInstancesCountIncidentStatus] = UNSET,
    ...
    url = "{}/history/process-instance/count".format(client.base_url)
...
def sync(
    *,
    ...
    Takes the same parameters as the [Get Process Instances](https://docs.camunda.org/manual/7.15/reference/rest/history/process-instance/get-process-instance-query/) method."""
