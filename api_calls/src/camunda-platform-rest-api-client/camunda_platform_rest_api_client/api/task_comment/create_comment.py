...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: CommentDto,
) -> Dict[str, Any]:
    url = "{}/task/{id}/comment/create".format(client.base_url, id=id)
...
) -> Optional[Union[AuthorizationExceptionDto, CommentDto, ExceptionDto]]:
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[AuthorizationExceptionDto, CommentDto, ExceptionDto]]:
    return Response(
