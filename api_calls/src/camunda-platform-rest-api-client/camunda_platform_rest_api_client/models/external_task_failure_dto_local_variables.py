...
T = TypeVar("T", bound="ExternalTaskFailureDtoLocalVariables")


@attr.s(auto_attribs=True)
class ExternalTaskFailureDtoLocalVariables:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        external_task_failure_dto_local_variables = cls()
        ...
        external_task_failure_dto_local_variables.additional_properties = additional_properties
        return external_task_failure_dto_local_variables
