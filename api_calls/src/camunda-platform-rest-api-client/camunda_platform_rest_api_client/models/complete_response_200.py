...
T = TypeVar("T", bound="CompleteResponse200")


@attr.s(auto_attribs=True)
class CompleteResponse200:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        complete_response_200.additional_properties = additional_properties
        return complete_response_200
