...
T = TypeVar("T", bound="CompleteExternalTaskDtoVariables")


@attr.s(auto_attribs=True)
class CompleteExternalTaskDtoVariables:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        complete_external_task_dto_variables = cls()
        ...
        complete_external_task_dto_variables.additional_properties = additional_properties
        return complete_external_task_dto_variables
