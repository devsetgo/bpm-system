...
T = TypeVar("T", bound="EvaluateDecisionDtoVariables")


@attr.s(auto_attribs=True)
class EvaluateDecisionDtoVariables:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        evaluate_decision_dto_variables = cls()
        ...
        evaluate_decision_dto_variables.additional_properties = additional_properties
        return evaluate_decision_dto_variables
