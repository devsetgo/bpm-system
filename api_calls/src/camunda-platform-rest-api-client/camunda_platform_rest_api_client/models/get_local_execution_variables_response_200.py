...
T = TypeVar("T", bound="GetLocalExecutionVariablesResponse200")


@attr.s(auto_attribs=True)
class GetLocalExecutionVariablesResponse200:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        get_local_execution_variables_response_200 = cls()
        ...
        get_local_execution_variables_response_200.additional_properties = additional_properties
        return get_local_execution_variables_response_200
