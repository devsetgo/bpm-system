...
T = TypeVar("T", bound="TriggerVariableValueDto")
...
class TriggerVariableValueDto:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        trigger_variable_value_dto = cls(
            value=value,
            type=type,
        ...
        trigger_variable_value_dto.additional_properties = d
        return trigger_variable_value_dto
