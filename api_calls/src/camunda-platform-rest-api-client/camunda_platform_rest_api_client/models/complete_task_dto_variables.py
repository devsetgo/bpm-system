...
T = TypeVar("T", bound="CompleteTaskDtoVariables")


@attr.s(auto_attribs=True)
class CompleteTaskDtoVariables:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        complete_task_dto_variables = cls()
        ...
        complete_task_dto_variables.additional_properties = additional_properties
        return complete_task_dto_variables
