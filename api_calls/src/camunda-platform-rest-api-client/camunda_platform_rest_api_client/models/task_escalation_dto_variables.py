...
T = TypeVar("T", bound="TaskEscalationDtoVariables")


@attr.s(auto_attribs=True)
class TaskEscalationDtoVariables:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        task_escalation_dto_variables = cls()
        ...
        task_escalation_dto_variables.additional_properties = additional_properties
        return task_escalation_dto_variables
