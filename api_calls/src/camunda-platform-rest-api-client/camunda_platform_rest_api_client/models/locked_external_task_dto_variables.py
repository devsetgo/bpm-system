...
T = TypeVar("T", bound="LockedExternalTaskDtoVariables")


@attr.s(auto_attribs=True)
class LockedExternalTaskDtoVariables:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        locked_external_task_dto_variables = cls()
        ...
        locked_external_task_dto_variables.additional_properties = additional_properties
        return locked_external_task_dto_variables
