...
T = TypeVar("T", bound="GetStartFormVariablesByKeyResponse200")


@attr.s(auto_attribs=True)
class GetStartFormVariablesByKeyResponse200:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        get_start_form_variables_by_key_response_200 = cls()
        ...
        get_start_form_variables_by_key_response_200.additional_properties = additional_properties
        return get_start_form_variables_by_key_response_200
