...
T = TypeVar("T", bound="StartProcessInstanceFormDtoVariables")


@attr.s(auto_attribs=True)
class StartProcessInstanceFormDtoVariables:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        start_process_instance_form_dto_variables = cls()
        ...
        start_process_instance_form_dto_variables.additional_properties = additional_properties
        return start_process_instance_form_dto_variables
