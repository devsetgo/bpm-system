...
T = TypeVar("T", bound="GetTaskVariablesResponse200")


@attr.s(auto_attribs=True)
class GetTaskVariablesResponse200:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        get_task_variables_response_200 = cls()
        ...
        get_task_variables_response_200.additional_properties = additional_properties
        return get_task_variables_response_200
