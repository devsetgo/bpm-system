...
T = TypeVar("T", bound="SubmitResponse200")


@attr.s(auto_attribs=True)
class SubmitResponse200:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        submit_response_200.additional_properties = additional_properties
        return submit_response_200
