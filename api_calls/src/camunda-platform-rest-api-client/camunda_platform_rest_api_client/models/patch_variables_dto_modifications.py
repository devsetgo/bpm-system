...
T = TypeVar("T", bound="PatchVariablesDtoModifications")


@attr.s(auto_attribs=True)
class PatchVariablesDtoModifications:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        patch_variables_dto_modifications = cls()
        ...
        patch_variables_dto_modifications.additional_properties = additional_properties
        return patch_variables_dto_modifications
