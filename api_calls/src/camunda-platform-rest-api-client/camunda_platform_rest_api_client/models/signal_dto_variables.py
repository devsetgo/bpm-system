...
T = TypeVar("T", bound="SignalDtoVariables")


@attr.s(auto_attribs=True)
class SignalDtoVariables:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        signal_dto_variables.additional_properties = additional_properties
        return signal_dto_variables
