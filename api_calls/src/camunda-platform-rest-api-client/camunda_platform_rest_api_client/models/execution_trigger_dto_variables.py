...
T = TypeVar("T", bound="ExecutionTriggerDtoVariables")


@attr.s(auto_attribs=True)
class ExecutionTriggerDtoVariables:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        execution_trigger_dto_variables = cls()
        ...
        execution_trigger_dto_variables.additional_properties = additional_properties
        return execution_trigger_dto_variables
