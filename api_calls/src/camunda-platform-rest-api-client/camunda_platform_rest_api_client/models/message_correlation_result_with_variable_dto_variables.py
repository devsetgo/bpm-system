...
T = TypeVar("T", bound="MessageCorrelationResultWithVariableDtoVariables")


@attr.s(auto_attribs=True)
class MessageCorrelationResultWithVariableDtoVariables:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        message_correlation_result_with_variable_dto_variables = cls()
        ...
        message_correlation_result_with_variable_dto_variables.additional_properties = additional_properties
        return message_correlation_result_with_variable_dto_variables
