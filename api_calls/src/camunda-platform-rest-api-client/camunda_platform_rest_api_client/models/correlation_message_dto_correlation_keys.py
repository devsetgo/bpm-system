...
T = TypeVar("T", bound="CorrelationMessageDtoCorrelationKeys")


@attr.s(auto_attribs=True)
class CorrelationMessageDtoCorrelationKeys:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        correlation_message_dto_correlation_keys = cls()
        ...
        correlation_message_dto_correlation_keys.additional_properties = additional_properties
        return correlation_message_dto_correlation_keys
