...
T = TypeVar("T", bound="GetFormVariablesResponse200")


@attr.s(auto_attribs=True)
class GetFormVariablesResponse200:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        get_form_variables_response_200 = cls()
        ...
        get_form_variables_response_200.additional_properties = additional_properties
        return get_form_variables_response_200
