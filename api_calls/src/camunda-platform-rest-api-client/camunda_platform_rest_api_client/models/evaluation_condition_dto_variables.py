...
T = TypeVar("T", bound="EvaluationConditionDtoVariables")


@attr.s(auto_attribs=True)
class EvaluationConditionDtoVariables:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        evaluation_condition_dto_variables = cls()
        ...
        evaluation_condition_dto_variables.additional_properties = additional_properties
        return evaluation_condition_dto_variables
