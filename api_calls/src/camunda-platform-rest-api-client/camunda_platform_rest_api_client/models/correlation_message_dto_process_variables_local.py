...
T = TypeVar("T", bound="CorrelationMessageDtoProcessVariablesLocal")


@attr.s(auto_attribs=True)
class CorrelationMessageDtoProcessVariablesLocal:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        correlation_message_dto_process_variables_local = cls()
        ...
        correlation_message_dto_process_variables_local.additional_properties = additional_properties
        return correlation_message_dto_process_variables_local
