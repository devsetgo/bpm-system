...
T = TypeVar("T", bound="GetProcessInstanceVariablesResponse200")


@attr.s(auto_attribs=True)
class GetProcessInstanceVariablesResponse200:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        get_process_instance_variables_response_200 = cls()
        ...
        get_process_instance_variables_response_200.additional_properties = additional_properties
        return get_process_instance_variables_response_200
